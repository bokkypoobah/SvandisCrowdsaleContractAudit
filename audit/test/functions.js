// ETH/USD 02 Jun 2018 01:55 AEDT from CMC and https://ethgasstation.info/
var ethPriceUSD = 575.20;
var defaultGasPrice = web3.toWei(12, "gwei");
...
addAccount(eth.accounts[2], "Account #2 - Withdraw Wallet");
...
var withdrawWallet = eth.accounts[2];
...
function printTokenContractDetails() {
  ...
  if (tokenContractAddress != null && tokenContractAbi != null) {
    ...
    console.log("RESULT: token.withdrawWallet=" + contract.withdrawWallet());
    console.log("RESULT: token.tiersSet=" + contract.tiersSet());
    console.log("RESULT: token.currentTier=" + contract.currentTier());
    console.log("RESULT: token.enableSale=" + contract.enableSale());
    console.log("RESULT: token.version=" + contract.version());
    console.log("RESULT: token.symbol=" + contract.symbol());
    console.log("RESULT: token.name=" + contract.name());
    console.log("RESULT: token.decimals=" + decimals);
    console.log("RESULT: token.totalSupply=" + contract.totalSupply().shift(-decimals));
    console.log("RESULT: token.getContractEth=" + contract.getContractEth().shift(-decimals));
